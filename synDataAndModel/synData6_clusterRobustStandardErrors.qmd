...
where: 
- $\epsilon^{cluster}_{c}$ is the cluster-level error term, assumed to be i.i.d. normal across clusters; 
- $\epsilon^{individ}_{i,t}$ is the individual-level error term, assumed to be i.i.d. normal across sites and time.
